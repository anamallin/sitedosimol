document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        ...
        const scriptURL = 'https://script.google.com/macros/s/AKfycbyRDHkVMkJFGTrV7fiojpReHqzixsdJa1CMKJAGXhkGh4SRkndSVnbKIjYfdbCpQBKaQg/exec';
    ...
    if (uploadForm) {
        ...
        const uploadScriptURL = 'https://script.google.com/macros/s/AKfycbyRDHkVMkJFGTrV7fiojpReHqzixsdJa1CMKJAGXhkGh4SRkndSVnbKIjYfdbCpQBKaQg/exec';
    ...
    if (festaCards) {
        ...
        const festaScriptURL = 'https://script.google.com/macros/s/AKfycbyRDHkVMkJFGTrV7fiojpReHqzixsdJa1CMKJAGXhkGh4SRkndSVnbKIjYfdbCpQBKaQg/exec';
