document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        ...
        const scriptURL = 'https://script.google.com/macros/s/AKfycbxi2LDROtDT3zQp3uS2w7ALXpTwDTZD-Gvg9vZx4NVVqLYhYIM9vC070EpHrzmVH1wjeA/exec'; 
    ...
    if (uploadForm) {
        ...
        const uploadScriptURL = 'https://script.google.com/macros/s/AKfycbxi2LDROtDT3zQp3uS2w7ALXpTwDTZD-Gvg9vZx4NVVqLYhYIM9vC070EpHrzmVH1wjeA/exec'; 
    ...
    if (festaCards) {
        ...
        const festaScriptURL = 'https://script.google.com/macros/s/AKfycbxi2LDROtDT3zQp3uS2w7ALXpTwDTZD-Gvg9vZx4NVVqLYhYIM9vC070EpHrzmVH1wjeA/exec';
