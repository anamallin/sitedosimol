document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        ...
        const scriptURL = 'https://script.google.com/macros/s/AKfycby2MQRVSJrdrnmln3kD_qhXYiNBLMzqbhO1yYyucq-zcBZHupITjh-lO-HlbpA-sefH6g/exec';
    ...
    if (uploadForm) {
        ...
        const uploadScriptURL = 'https://script.google.com/macros/s/AKfycby2MQRVSJrdrnmln3kD_qhXYiNBLMzqbhO1yYyucq-zcBZHupITjh-lO-HlbpA-sefH6g/exec';
    ...
    if (festaCards) {
        ...
        const festaScriptURL = 'https://script.google.com/macros/s/AKfycby2MQRVSJrdrnmln3kD_qhXYiNBLMzqbhO1yYyucq-zcBZHupITjh-lO-HlbpA-sefH6g/exec';
